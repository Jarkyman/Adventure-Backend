...
public class BookingController {
  ...
  /**
   * Create a booking, get a request body in json. send data to database and save the booking object
   * in database.
   *
  ...
  /**
   * Update a booking, by id of the booking that needs update, and update with new request-body.
   *
   * @param id booking id
